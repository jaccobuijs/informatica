...
def bereken_bmi():
    try:
        ...
        bmi_label.configure(text="Ongeldige invoer, voer alstublieft getallen in!")
...
gewicht_label = ttk.Label(root, text="Gewicht (kg)")
...
lengte_label = ttk.Label(root, text="Lengte (cm)")
